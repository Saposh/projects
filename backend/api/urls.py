...
urlpatterns = [
    ...
    path('user/change_password/', api_views.ChangePasswordAPIView.as_view()),


    #Core Endpoints
    path("course/category/", api_views.CategoryListAPIView.as_view()),
    path("course/course-list/", api_views.CourseListAPIView.as_view()),
    path("courses/search", api_views.SearchCourseAPIView.as_view()),
    ...
    path("student/course-completed/", api_views.StudentCourseCompleteCreateAPIView.as_view()),
    ...
    path("student/rate-detail/<user_id>/<review_id>", api_views.StudentRateCourseUpdateAPIView.as_view()),
    path("student/rate-detail/<user_id>/<review_id>", api_views.StudentRateCourseUpdateAPIView.as_view()),
